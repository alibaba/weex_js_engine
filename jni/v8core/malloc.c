  ...
  if (MORECORE_CONTIGUOUS && !use_noncontiguous(m)) {
    ...
    if (tbase == CMFAIL) {    /* Cope with partial failure */
      ...
      if (br != CMFAIL) {    /* Use the space we did get */
        ...
        __android_log_print(ANDROID_LOG_DEBUG, "LINZJ", "disable_contiguous\n");
      }
    }
...
*/
void* malloc(size_t) __attribute__((visibility("hidden"), alias("dlmalloc")));

void* calloc(size_t item_count, size_t item_size) __attribute__((visibility("hidden"), alias("dlcalloc")));

void* realloc(void* p, size_t byte_count) __attribute__((visibility("hidden"), alias("dlrealloc")));
void free(void* ptr) __attribute__((visibility("hidden"), alias("dlfree")));

void* memalign(size_t alignment, size_t bytes) __attribute__((visibility("hidden"), alias("dlmemalign")));

int posix_memalign(void **memptr, size_t alignment, size_t size) __attribute__((visibility("hidden"), alias("dlposix_memalign")));;

/*  c++ operator new/delete family.  */
void* _Znwj(size_t) __attribute__((visibility("hidden"), alias("dlmalloc")));
void* _Znaj(size_t) __attribute__((visibility("hidden"), alias("dlmalloc")));
void _ZdaPv(void*) __attribute__((visibility("hidden"), alias("dlfree")));
void _ZdlPv(void*) __attribute__((visibility("hidden"), alias("dlfree")));
